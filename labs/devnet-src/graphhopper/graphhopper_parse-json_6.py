...
while True:
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        # En la versión 6, el vehículo suele estar fijo como "car" o usar la variable previa
        ...
        if paths_status == 200:
            ...
            # Manejo de error de routing (Paso 7)
